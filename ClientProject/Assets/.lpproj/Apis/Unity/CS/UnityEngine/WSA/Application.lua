...
function CS.UnityEngine.WSA.Application.TryInvokeOnAppThread(item, waitUntilDone)
end

---@param item : CS.UnityEngine.WSA.AppCallbackItem
---@param waitUntilDone : CS.System.Boolean
---@return CS.System.Boolean
function CS.UnityEngine.WSA.Application.TryInvokeOnUIThread(item, waitUntilDone)
end
