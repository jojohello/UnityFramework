...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIStageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 25, 8, 3);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Dispose", _m_Dispose);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetFous", _m_SetFous);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 2, 5, 3);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetFous(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<FairyGUI.DisplayObject>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.SetFous( _newFocus, _byKey );
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.DisplayObject>(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.SetFous( _newFocus );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.Stage.SetFous!");
        ...
        static int _m_DoKeyNavigate(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DoKeyNavigate( _backward );
		    ...
		    try {
                ...
                
                {
                    int _touchId = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.DisplayObject gen_ret = gen_to_be_invoked.GetTouchTarget( _touchId );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.EventDispatcher _target = (FairyGUI.EventDispatcher)translator.GetObject(L, 2, typeof(FairyGUI.EventDispatcher));
                        ...
                        bool gen_ret = gen_to_be_invoked.IsTouchMonitoring( _target );
        ...
        static int _m_RegisterCursor(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RegisterCursor( _cursorName, _texture, _hotspot );
