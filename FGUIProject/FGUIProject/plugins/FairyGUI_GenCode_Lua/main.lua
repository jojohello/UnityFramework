...
local customPropKeys = {
    ...
    key_lua_file_extension_name = { name = "key_lua_file_extension_name", default_value = "bytes" },
    key_lua_path_root = { name = "key_lua_path_root", default_value = "UIScripts/" },
...
function genCode(handler)
 ...
 local _bindEventInstatiation = "";
    ...
    --     return CS.System.IO.File.ReadAllText(handler.exportCodePath .. "/init.bytes");
    -- end);
    ...
    --     CS.System.IO.File.WriteAllText(handler.exportCodePath .. "/init.bytes", _initTxt);
    -- end
end
